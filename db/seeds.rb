...
Event.create(:title => "SEOINAGE", :when => "2017-9-27T17:30", :where => "Seattle", :what => "Judo")
Event.create(:title => "Climbing Mt", :when => "2017-9-23T04:30", :where => "CA", :what => "Mountain-climbing")
Event.create(:title => "Let's do Ping pong", :when => "2017-9-19T22:30", :where => "New York", :what => "Ping pong")
Event.create(:title => "Stronger!!", :when => "2017-9-23T14:30", :where => "Detroit", :what => "Boxing")
Event.create(:title => "Feeling running!!", :when => "2017-9-25T05:30", :where => "Detroit", :what => "Running")
Event.create(:title => "Let’s get experience", :when => "2017-9-21T5:30", :where => "Portland", :what => "Canoeing")
Event.create(:title => "Find speed", :when => "2017-9-19T13:30", :where => "Austi", :what => "Sprint")
Event.create(:title => "How to play Football", :when => "2017-9-26T14:30", :where => "SF", :what => "Football")
Event.create(:title => "Let’s go a long way by bicycle", :when => "2017-9-27T08:30", :where => "Texas", :what => "Bike")
Event.create(:title => "Learn Techniques", :when => "2017-9-22T11:30", :where => "San jase", :what => "BMX")
Event.create(:title => "Penetration", :when => "2017-9-09T13:30", :where => "Phoinix", :what => "Archery")
Event.create(:title => "Throwing", :when => "2017-9-13T19:30", :where => "Brick", :what => "Softball")
Event.create(:title => "Daiet", :when => "2017-9-15T05:30", :where => "Concord", :what => "Running")
Event.create(:title => "Fun to do it", :when => "2017-9-01T07:30", :where => "Daly city", :what => "Badminton")
Event.create(:title => "Go for the goal", :when => "2017-9-09T13:30", :where => "Pacifica", :what => "Futsal")
Event.create(:title => "Can you parasol ?", :when => "2017-9-06T13:30", :where => "San Mateo", :what => "Ski")
